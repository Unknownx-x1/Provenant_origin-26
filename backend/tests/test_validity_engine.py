...
def test_validity_score_calculation():
    nodes = [
        EvidenceNode(id="e1", type=EvidenceType.NEWS, weight=0.35, source="Bloomberg Breaking", captured_at="2026-08-28T16:00:00Z"),
        EvidenceNode(id="e2", type=EvidenceType.MOMENTUM, weight=0.25, source="RSI_14", captured_at="2026-08-28T16:00:00Z"),
        EvidenceNode(id="e3", type=EvidenceType.ORDERBOOK, weight=0.25, source="Depth Proxy", captured_at="2026-08-28T16:00:00Z")
    ]
